Raspberry Pi 5 Headless VNC Setup
==================================

This document describes the full steps to set up a **headless Raspberry Pi 5** 
(using only LAN and no HDMI monitor) with **GUI (LXDE)** accessible via **RealVNC Viewer**.
